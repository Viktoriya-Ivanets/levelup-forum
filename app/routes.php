...
Router::add('categories(/page/(\d+))?', ['controller' => 'Category', 'action' => 'index']);
...
Router::add('categories/(\d+)/topics(/page/(\d+))?', ['controller' => 'Topic', 'action' => 'index']);
...
Router::add('categories/(\d+)/topics/(\d+)/messages(/page/(\d+))?', ['controller' => 'Message', 'action' => 'index']);
